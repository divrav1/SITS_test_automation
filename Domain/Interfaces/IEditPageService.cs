...
namespace SITS_Test_Automation.Domain.Interfaces
{
    ...
    {
        Task<List<NavigateToEditResponse>> NavigateToEditAsync(NavigateToEditRequest request);

        Task<ReleaseTextResponse> ReleaseTextAsync(ReleaseTextRequest request);
